...
export class PrescriptionDetail extends React.Component {
  ...
  onCreate() {
    var prescription = this.state;
    console.log("prescupton: ", this.state.prescription);
            ...
            <form name="prescription" className="mt-3">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  id="createdDate"
                  name="createdDate"
                  value={this.state.prescription.createdDate}
                  onChange={this.changeHandler}
                />
              </div>
            </form>
        ...
        <div className="close-margin">
          ...
          <form name="prescription" className="mt-3">
            <div className="form-group">
              ...
              <input
                ...
                id="name"
                name="name"
                value={this.state.prescription.name}
                onChange={this.changeHandler}
              />
            </div>
            <div className="form-group">
              ...
              <input
                ...
                id="medication"
                name="medication"
                value={this.state.prescription.medication}
                onChange={this.changeHandler}
              />
            </div>
            <div className="form-group">
          ...
          <div className="text-right mt-4">
            <button
              type="button"
              className="btn btn-lg btn-primary ml-5"
              onClick={() => console.log("FIXME: route to pick pharmacy page")}
            >
              Pick Pharmacy
            </button>
          </div>
  ...
  componentDidMount() {
    if (!this.props.match.path.endsWith("/prescription-creation")) {
      ...
      this.prescriptionRepository
        .getPrescription(id)
        .then((p) => this.setState({ prescription: p }));
    } else {
